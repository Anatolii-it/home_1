...
void addEmployee() {
    ...
    cin >> emp.kWt_month;
    cout << "Введіть кількість відімого сонця: ";
    cin >> emp.time_day;
...
void editEmployee() {
    int phone;
    cout << "Введіть номер телефона для редагування: ";
    cin >> phone;
    cout << "#---------------------------------------------#" << endl;
    for (auto& emp : employees) {
        if (emp.phone == phone) {
            cout << "  Введіть кількість кВт в місяць ";
            cin >> emp.kWt_month;
            cout << "  Введіть кількість часу впевненого сонця ";
            cin >> emp.time_day;
            cout << "  Введіть найпотужний об'єкт кВт: ";
            cin >> emp.Max_power_h;
    ...
    for (const auto& emp : employees) {
        if (emp.phone == phone) {
            cout << "Телефон: " << emp.phone << "\n"
                ...
                << "    Кількість часу впевненого сонця  " << emp.time_day << "\n"
                << "    Найпотужний об'ект кВт: " << emp.Max_power_h << endl;
            cout << "#---------------------------------------------#" << endl;

            p = emp.Max_power_h;
            a = double(emp.kWt_month / 31);
            if (a >= 0.0 && a <= 2) {
            ...
            if (p > 2.0 && p <= 3.0) {
                ...
                cout << "#  Потрібен інвертор   6,0 кВт                #" << endl;
                cout << "#---------------------------------------------#" << endl;
                cout << "#    Ціна комплекту - " << cina << " Грн               #" << endl;
            }
            if (p > 3.0 && p <= 4.0) {
            ...
            if (p > 4.0 && p <= 5.0) {
                ...
                cout << "#  Потрібен інвертор   10,0 кВт                #" << endl;
                cout << "#---------------------------------------------#" << endl;
                cout << "#    Ціна комплекту - " << cina << " Грн               #" << endl;
            }
            if (p > 5.0 && p <= 7.0) {
            ...
            if (p > 8) {
                cout << "   Потрібен індивидуальний розрахунок" << endl;
                cout << "#---------------------------------------------#" << endl;
...
void displayAllEmployees() {
    ...
    for (const auto& emp : employees) {
        cout << "Телефон: " << emp.phone << "\n"
            << "    кВт місяць: " << emp.kWt_month << "\n"
            << "    Кількість часів впевненого сонця: " << emp.time_day << "\n"
